...
var AudioVisualiser = function (_Component) {
  ...
  createClass(AudioVisualiser, [{
    ...
    value: function render() {
      return React.createElement('canvas', { id: '' + styles.canvasAudio, height: '300', ref: this.canvas });
    }
  }]);
  ...
  createClass(AudioAnalyser, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(AudioVisualiser, {
...
var Microphone = function (_Component) {
  ...
  function Microphone(props) {
    ...
    _this.audioinput = [];
    _this.elementRef = new React.createRef();
  ...
  createClass(Microphone, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.state.audio ? React.createElement(AudioAnalyser, { audio: this.state.audio }) : ''
      );
    }
  }]);
  return Microphone;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'row' },
            this.state.permissionMic ? React.createElement(Microphone, { changeKindId: function changeKindId(kindId) {
          ...
          React.createElement(
            'div',
            { className: 'row' },
            this.state.permissionCam ? React.createElement(Camera, null) : React.createElement(Error, {
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'row' },
            this.state.kindId && React.createElement(Audio, { kindId: this.state.kindId })
          )
        )
      );
    }
